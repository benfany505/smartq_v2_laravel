  ...
  <div class="ml-1 mr-1">
      <nav class="main-header navbar navbar-expand navbar-white navbar-light"
          style="background-color: #222F3E; border: none">
          <!-- Left navbar links -->
          <ul class="navbar-nav">
              <li class="nav-item">
              ...
              <li class="nav-item">
                  <h6 class="m-0 nav-link" style="color: #ffffff"><?= $title ?></h6>
              </li>
          ...
          <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                  {{-- <div class="m-0 nav-link" style="color: #ffffff">Last Login : 09 Sep 2022</div> --}}
              </li>
              <!-- Navbar Search -->
              {{-- <li class="nav-item">
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                  ...
                  <a href="#" class="dropdown-item text-sm">
                      <i class="fas fa-edit mr-2 text-sm"></i> Edit Profile

                  </a>
                  <div class="dropdown-divider"></div>
                  <a href="#" class="dropdown-item text-sm">
                      <i class="fas fa-door-open mr-2 text-sm"></i> Logout
                  </a>
              </div>
          </li>
          <li class="nav-item">
